...
var CanvasJSReact = require('../../Common/lib/canvasjs.react')
...
class DrillDown extends Component {
  constructor () {
    super()
    this.options = {}
    this.visitorsChartDrilldownHandler = this.visitorsChartDrilldownHandler.bind(
      this
    )
  }
  ...
  render () {
    ...
    return (
      <div>
        ...
        <button className='btn invisible' id='backButton' style={buttonStyle}>
          &lt; Back
        </button>
      </div>
    )
