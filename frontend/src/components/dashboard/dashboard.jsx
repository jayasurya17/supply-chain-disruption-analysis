    ...
    return (
        <div className="HomeContainer">
            ...
            <div className="m-5" id="description">
                ...
                <p>Based on data obtained from <a href="https://quickstats.nass.usda.gov/" target="blank" className="text-decoration-none">UDSA</a> and <a href="https://public.emdat.be/" target="blank" className="text-decoration-none">EM-DAT</a>, we are showing graphs and charts from the year 1980 until 2020.
                These dashboards visually represent the correlation between different disasters and supply chain data for food and medicine. Line charts, heat maps, table charts, etc. are designed to show changes during different years and for different commodities measured in multiple units for different states of the USA.</p>
            </div>
