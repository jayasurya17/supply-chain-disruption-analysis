...
class ExportBasedAnalysis extends Component {
    ...
    componentDidMount() {
        axios.get(`/filters/exportByStateCommodities`).then(allCommoditiesResponse => {
            this.setState({
                allCommodities: allCommoditiesResponse.data,
                selectedCommodity: allCommoditiesResponse.data[0]
            })
            this.updateGraph(
                allCommoditiesResponse.data[0],
    ...
    updateGraph = (commodity, startYear, endYear) => {
        axios
            ...
            .then(commoditiesByStateResponse => {
                console.log(commoditiesByStateResponse)
                this.setState({
